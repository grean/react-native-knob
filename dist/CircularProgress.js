...
import Svg, { Defs, Stop, Path, Circle, RadialGradient, Text } from 'react-native-svg';
...
export default ({ canvasSize, strokeWidth, rotation, value, maxValue, padding, strokeWidthDecoration, negative, colors, gradientInt, gradientExt, textStyle, textDisplay }) => {
      ...
      <PanGestureHandler ref={knobPanRef} simultaneousHandlers={knobTapRef} onHandlerStateChange={onGestureEvent} onGestureEvent={onGestureEvent}>
        ...
        ...StyleSheet.absoluteFillObject,
              ...
              <Svg width={canvasSize} height={canvasSize}>
                ...
                <AnimatedCircle {...{ strokeWidth: strokeWidthDecoration, cx, cy, r: rPlate }} stroke="url(#radialPlateExt)" 
    // stroke={plateColor}
    fill="none"/>
    ...
    {...{ strokeWidth }}/>
        ...
        justifyContent: 'space-evenly',
                  ...
                  <ReText text={concat(round(add(multiply(divide(endAngle, 2 * PI), 100), multiply(100, aroundCount))))} style={{
        ...{
            color: 'white',
